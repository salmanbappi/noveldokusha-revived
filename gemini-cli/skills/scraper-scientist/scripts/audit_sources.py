...
SOURCES = {
    "RoyalRoad": {
        ...
        "selectors": {
            "title": "h1", "cover": "img.thumbnail", "chapters": "#chapters tbody tr a[href]"
        }
    },
    "WuxiaWorld": {
        "url": "https://www.wuxiaworld.com/novel/against-the-gods",
        "selectors": {
            "title": "h1", "cover": "img[src*=covers]", "chapters": "a[href*=-chapter-]"
        }
    },
    "NovelBin": {
        "url": "https://novelbin.com/b/shadow-slave",
        "selectors": {
            "title": ".title", "cover": ".book img", "chapters": "li a"
        }
    },
    "NovelFull": {
        "url": "https://novelfull.com/the-beginning-after-the-end.html",
        "selectors": {
            "title": "h3.title", "cover": ".book img", "chapters": "#list-chapter li a"
        }
    }
}
        ...
        try:
            ...
            for key, sel in data['selectors'].items():
                ...
                if key == "cover" and not found:
                    ...
                    found = soup.select(f"img[alt*='{title.take(5) if title else ''}']")
